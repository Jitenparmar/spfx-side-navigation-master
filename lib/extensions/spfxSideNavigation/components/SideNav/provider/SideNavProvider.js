...
var SideNavProvider = (function () {
    ...
    SideNavProvider.prototype.getSideNav = function () {
        var _this = this;
        return sp.web.lists.getByTitle("Shortcuts").items.select("ID", "Title", "LinkType", "Link")
            ...
            debugger;
            var siteNavItems = [];
            if (_this.existsItemsInShortcuts(items, 'Page')) {
                siteNavItems.push({
                    title: 'Pages',
                    ...
                    subNavItems: _this.getSubNavItemsByShortcuts(items, 'Page')
                });
            }
            if (_this.existsItemsInShortcuts(items, 'Hyperlink')) {
                siteNavItems.push({
                    title: 'Hyperlinks',
                    svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-external-link"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>',
                    url: '', openInNewWindow: false,
                    subNavItems: _this.getSubNavItemsByShortcuts(items, 'Hyperlink')
                });
            }
            if (_this.existsItemsInShortcuts(items, 'Library')) {
                siteNavItems.push({
                    title: 'Libraries',
                    ...
                    url: '', openInNewWindow: false,
                    subNavItems: _this.getSubNavItemsByShortcuts(items, 'Library')
                });
            }
            if (_this.existsItemsInShortcuts(items, 'List')) {
                siteNavItems.push({
                    title: 'Lists',
                    svg: '<svg xmlns="http://www.w3.org/2000/svg"   viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-list"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3" y2="6"></line><line x1="3" y1="12" x2="3" y2="12"></line><line x1="3" y1="18" x2="3" y2="18"></line></svg>',
                    url: '', openInNewWindow: false,
                    subNavItems: _this.getSubNavItemsByShortcuts(items, 'List')
                });
            }
            /**
    ...
    SideNavProvider.prototype.getSubSitesNav = function () {
        var _this = this;
        return sp.web.webs.select("Title", "Url").get().then(function (items) { return __awaiter(_this, void 0, void 0, function () {
            var subNavItems, siteNavItems;
    ...
    */
    SideNavProvider.prototype.getSubSites = function (web) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, subNavItems.length > 0 ? subNavItems : undefined];
            });
        });
    };
    SideNavProvider.prototype.existsSubWebs = function (web) {
        var rtn = false;
    ...
    SideNavProvider.prototype.existsItemsInShortcuts = function (spNavItems, filter) {
        var rtn = false;
    ...
    SideNavProvider.prototype.getSubNavItemsByShortcuts = function (spNavItems, filter) {
        var subNavItems = [];
        spNavItems.forEach(function (item) {
            if (item.LinkType === filter) {
    ...
    SideNavProvider.prototype.getSubNavItems = function (spNavItems, filter) {
        var subNavItems = [];
        spNavItems.forEach(function (item) {
...
//# sourceMappingURL=SideNavProvider.js.map
